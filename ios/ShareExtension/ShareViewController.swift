...
class ShareViewController: SLComposeServiceViewController {
  ...
  let hostAppBundleIdentifier = "com.internxt.snacks"
  let shareProtocol = "inxt" //share url protocol (must be unique to your app, suggest using your apple bundle id, ie: `hostAppBundleIdentifier`)
